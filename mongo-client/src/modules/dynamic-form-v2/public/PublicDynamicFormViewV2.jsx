...
import PublicDynamicAddEditFormV2 from "./PublicDynamicAddEditFormV2";
import { useSettings } from "@/context/SettingsContext";

const { Title, Paragraph } = Typography;

export default function PublicDynamicFormViewV2({ form_slug }) {
  ...
  if (submitted) {
    return (
      ...
      >
        ...
        >
          <Typography.Title level={3} style={{ color: primaryColor }}>
            Registration Submitted Successfully!
          </Typography.Title>
          <Typography.Paragraph type="secondary">
            Your submission has been securely recorded and queued for CSR Admin review.
