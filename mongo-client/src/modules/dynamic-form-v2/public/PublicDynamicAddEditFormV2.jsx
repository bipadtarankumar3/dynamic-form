...
import AddMoreSectionV2 from "../add-edit/add-more-section/AddMoreSectionV2";
import GeneralSectionV2 from "../add-edit/general-section/GeneralSectionV2";
import CaptchaWidget from "@/components/CaptchaWidget";
import { getDynamicFormHooks } from "../hooks/dynamicFormHookRegistryV2";
import { useSettings } from "@/context/SettingsContext";

const PublicDynamicAddEditFormV2 = forwardRef((props, ref) => {
  ...
  const handleSubmit = useCallback(async () => {
    ...
    try {
      ...
      console.error("[PublicDynamicAddEditFormV2] Submission error:", error);
  ...
  useEffect(() => {
    const loadSchema = async () => {
      ...
      try {
        ...
        console.error("[PublicDynamicAddEditFormV2] Load schema error:", err);
...
export default PublicDynamicAddEditFormV2;
