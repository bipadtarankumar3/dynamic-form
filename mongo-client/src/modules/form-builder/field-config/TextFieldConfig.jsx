          ...
          // ================= VALIDATION =================
          {
            ...
            children: (
              <div className="tfc-val-list">
                ...
                {/* EMAIL */}
                <div
                  className={`tfc-val-row ${activeField?.validation?.email ? "tfc-val-row--active" : ""}`}
                >
                  <div className="tfc-val-left">
                    <Switch
                      checked={activeField?.validation?.email || false}
                      onChange={(checked) => {
                        updateNested("validation", "email", checked);
                      }}
                    />
                    <span className="tfc-val-name">Email</span>
                  </div>
                  {activeField.validation?.email && (
                    <div className="tfc-val-right">
                      <span className="tfc-msg-label">Message</span>
                      <Input
                        className="tfc-input tfc-input--msg"
                        placeholder="Email message"
                        value={activeField?.messages?.email || ""}
                        onChange={(e) =>
                          updateNested("messages", "email", e.target.value)
                        }
                      />
                    </div>
                  )}
