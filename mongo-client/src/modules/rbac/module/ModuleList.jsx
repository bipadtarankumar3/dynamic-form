...
import ModuleUpsert from "./ModuleUpsert";
...
const ModuleList = () => {
  ...
  const initPlotListDatatable = (my_url) => {
    ...
    return $("#module_list_table").DataTable({
      order: [[1, "asc"]],
      dom:
  ...
  useEffect(() => {
    const apiUrl = `${process.env.NEXT_PUBLIC_API_URL}/rbac/mod/dt`;
